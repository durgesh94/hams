...
import type { CreatePatientRequest } from "../../features/patients/types";
...
const AddForm = ({ onSubmit, isSubmitting = false }: AddFormProps) => {
	const {
		control,
		register,
		handleSubmit,
			...
			<Controller
				...
				render={({ field }) => (
					...
					>
						...
						<Select {...field} labelId="patient-gender-label" label="Gender">

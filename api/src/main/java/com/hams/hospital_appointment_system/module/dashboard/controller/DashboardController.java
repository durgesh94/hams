...
public class DashboardController {
  ...
  @GetMapping("/month")
  public ResponseEntity<ApiResponse<MonthlyDashboardResponse>> getMonthlyStatistics(
      @RequestParam YearMonth month) {
    MonthlyDashboardResponse monthlyDashboardResponse =
        dashboardService.getMonthlyStatistics(month);
    ApiResponse<MonthlyDashboardResponse> apiResponse =
        ApiResponse.<MonthlyDashboardResponse>builder()

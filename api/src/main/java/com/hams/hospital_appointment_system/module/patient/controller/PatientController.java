...
public class PatientController {
  ...
  public ResponseEntity<ApiResponse<List<PatientResponse>>> getAllPatients() {
    ...
    ApiResponse<List<PatientResponse>> response =
  ...
  public ResponseEntity<ApiResponse<PatientResponse>> updatePatientById(
      @PathVariable Long id, @Valid @RequestBody PatientRequest patientRequest) {
  ...
  public ResponseEntity<Void> deletePatientById(@PathVariable Long id) {
    ...
    // Note: The response object is created but not returned because HTTP 204 No Content should not

...
class AuthControllerTest {
  ...
  void login_shouldReturnOk_whenCredentialsAreValid() throws Exception {
    ...
    LoginRequest request = LoginRequest.builder().username("johndoe").password("secret").build();
  ...
  void login_shouldReturnBadRequest_whenUsernameIsBlank() throws Exception {
    ...
    LoginRequest request = LoginRequest.builder().username("").password("secret").build();
  ...
  void login_shouldReturnBadRequest_whenPasswordIsBlank() throws Exception {
    ...
    LoginRequest request = LoginRequest.builder().username("johndoe").password("").build();

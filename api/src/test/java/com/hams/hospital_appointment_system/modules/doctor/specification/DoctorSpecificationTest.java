...
class DoctorSpecificationTest {
  ...
  private Doctor buildDoctor(
      String email, Gender gender, String specialization, DoctorStatus status) {
  ...
  void byFilter_shouldReturnDoctors_matchingGender() {
    ...
    doctorRepository.save(
        buildDoctor("male1@test.com", Gender.MALE, "Cardiology", DoctorStatus.ACTIVE));
    doctorRepository.save(
        buildDoctor("female1@test.com", Gender.FEMALE, "Cardiology", DoctorStatus.ACTIVE));
  ...
  void byFilter_shouldReturnDoctors_matchingSpecializationCaseInsensitive() {
    ...
    doctorRepository.save(
        buildDoctor("cardio@test.com", Gender.MALE, "Cardiology", DoctorStatus.ACTIVE));
    doctorRepository.save(
        buildDoctor("neuro@test.com", Gender.MALE, "Neurology", DoctorStatus.ACTIVE));
  ...
  void byFilter_shouldReturnDoctors_matchingStatus() {
    ...
    doctorRepository.save(
        buildDoctor("active@test.com", Gender.MALE, "Cardiology", DoctorStatus.ACTIVE));
    doctorRepository.save(
        buildDoctor("inactive@test.com", Gender.MALE, "Cardiology", DoctorStatus.INACTIVE));
  ...
  void byFilter_shouldReturnDoctors_matchingAllFiltersCombined() {
    ...
    doctorRepository.save(
        buildDoctor("match@test.com", Gender.FEMALE, "Neurology", DoctorStatus.ACTIVE));
    doctorRepository.save(
        buildDoctor("nomatch1@test.com", Gender.MALE, "Neurology", DoctorStatus.ACTIVE));
    doctorRepository.save(
        buildDoctor("nomatch2@test.com", Gender.FEMALE, "Cardiology", DoctorStatus.ACTIVE));
    doctorRepository.save(
        buildDoctor("nomatch3@test.com", Gender.FEMALE, "Neurology", DoctorStatus.INACTIVE));
  ...
  void byFilter_shouldReturnAllDoctors_whenNoFiltersProvided() {
    ...
    doctorRepository.save(
        buildDoctor("doc1@test.com", Gender.MALE, "Cardiology", DoctorStatus.ACTIVE));
    doctorRepository.save(
        buildDoctor("doc2@test.com", Gender.FEMALE, "Neurology", DoctorStatus.INACTIVE));
